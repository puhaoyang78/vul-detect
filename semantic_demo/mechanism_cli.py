...
from .mechanism_model import evaluate_mechanism_models, train_mechanism_models
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description='Function-only patch-grounded CPG mechanism learning experiment'
    )
